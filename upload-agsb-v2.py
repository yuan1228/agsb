...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "yuanruixuan"         # 用户名
UUID = "ca7135fd-0bf7-4867-b7d1-db749f274901"                     # UUID，留空则自动生成
PORT = 39899                   # Vmess端口，留空或0则自动生成
DOMAIN = "guge.yuanrui.filegear-sg.me"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiODc3ODFhODk5MTAzMjU4M2U0MGY0ZjJhNWNjMDFkMDYiLCJ0IjoiYTRlODhlNzktMThhMS00ZjVmLTlmMjgtNjczMTQxYjRkN2RlIiwicyI6Ik5UVmlPV0UxT0RjdE1EUTRNeTAwTWpBMUxUbGxabU10TldVMk1EUTJOV1UzTm1KbCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
